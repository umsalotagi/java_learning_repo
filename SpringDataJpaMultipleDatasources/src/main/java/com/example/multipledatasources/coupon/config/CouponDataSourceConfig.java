package com.example.multipledatasources.coupon.config;
...
basePackages = {"com.example.multipledatasources.coupon"})
public class CouponDataSourceConfig {
	...
	couponEntityManagerFactory(EntityManagerFactoryBuilder builder) {
